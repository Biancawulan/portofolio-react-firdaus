      ...
      <div className="container mx-auto max-w-[1200px] p-3 overflow-hidden">
        <div className="font-secondary text-center font-bold mb-12">
          ...
          <h2 className="text-gradient font-primary max-w-[700px] mx-auto text-[24px]">
            ...
            perferendis molestiae eum explicabo autem enim. Provident placeat
            quo voluptate harum cupiditate nulla perspiciatis ipsum doloribus.
            Quidem nam culpa pariatur vitae?
          </h2>
        </div>
        <div className="flex flex-col lg:flex-row items-start justify-between">
          <div className="text-center w-full max-w-[400px] mx-auto mb-[50px]">
            ...
            <h2 className="text-gradient text-[50px] mt-[20px]">
              Muhammad Firdaus Bina Rajendra
            </h2>
          </div>
                  ...
                  <div className="absolute p-5 backdrop-blur-xl bg-primary w-full h-full flex items-center opacity-0 scale-0 group-hover:scale-100 group-hover:opacity-100 transition ease-linear">
                    <div className="text-center w-full text-white ">
                      ...
                      <p>
                        ...
                        Fugiat ratione, ab voluptatum expedita inventore
                        voluptatibus rerum esse earum possimus, reprehenderit
                        repellat eligendi blanditiis. Excepturi non nobis,
                        tempore laborum maxime dolores.
                      </p>
                    </div>
                  </div>
                </div>
